...
在2010的ImageNet LSVRC比赛上取得了第一，TOP-1：37.5%，TOP-5：15.3%，远远超过第二名的TOP-5：26.2%。
...
为了从ImageNet的数百万张高分辨的图像中学习到几千个对象，提出了CNNs（Convolutional nerual networks），具有统计上的稳定性，并且对像素有局部性的依赖（卷积直接导致）。与有同层次的前馈，CNNs具有更少的连接和参数，更易于训练，但是理论最优性能稍差于前馈。
